...
__all__ = ["ClickDailyCountsResponse", "Links", "Meta", "Object"]
...
class Object(BaseModel):
    ...
    """The count associated with the date."""

    date: Optional[str] = None
    """The UTC date in YYYY-MM-DD format"""

    scan_count: Optional[int] = None
    """The scan count associated with the date."""

    unix_date: Optional[int] = None
    """The UTC unix timestamp of the start of the date"""


class ClickDailyCountsResponse(BaseModel):
