        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"domain_id": domain_id}, group_list_params.GroupListParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"domain_id": domain_id}, group_list_params.GroupListParams),
            ),
            cast_to=GroupListResponse,
        )
